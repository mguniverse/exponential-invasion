...
//
//  Created by Danny Perski on 12/20/11.
...
-(void)winLevel {
    ...
    if (steps <= topSteps) {
        [endBombs setImage:[UIImage imageNamed:[NSString stringWithFormat:@"bombs3-large.png"]]];
        if (currentLevel == 1) {
            if (level1bombs < 3) {
                level1bombs = 3;
                [[NSUserDefaults standardUserDefaults] setInteger:level1bombs forKey:@"savedBombs1"];
    ...
    if (steps > topSteps && steps < topSteps*2) {
        [endBombs setImage:[UIImage imageNamed:[NSString stringWithFormat:@"bombs2-large.png"]]];
        if (currentLevel == 1) {
            if (level1bombs < 2) {
                level1bombs = 2;
                [[NSUserDefaults standardUserDefaults] setInteger:level1bombs forKey:@"savedBombs1"];
    ...
    if (steps >= topSteps*2) {
        [endBombs setImage:[UIImage imageNamed:[NSString stringWithFormat:@"bombs1-large.png"]]];
        if (currentLevel == 1) {
            if (level1bombs < 1) {
                level1bombs = 1;
                [[NSUserDefaults standardUserDefaults] setInteger:level1bombs forKey:@"savedBombs1"];
